...
model_path = 'models/ckpt/myCharClassifier.ckpt-3000'
...
def eval():
    with tf.Session() as sess:
        ...
        for image_path in images_paths:
            ...
            softmax_out,pred_class=sess.run([_softmax_output,_classes],feed_dict={_inputs:image_data})
            ...
            print("accuary:",correct_cnt/total_num)
