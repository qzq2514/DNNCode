...
model_path = 'models/pb/myCharClassifier-3000.pb'
eval_dir=   "D:/forTensorflow/charRecTrain/test/"
            #"D:/forTensorflow/charRecTrain/data/test/test/"
            #"D:/forTensorflow/charRecTrain/test/"
...
def eval():
    with tf.Session() as sess:
        ...
        # _classes = sess.graph.get_default_graph().get_tensor_by_name('classes:0')
