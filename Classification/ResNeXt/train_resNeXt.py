...
from nets import ResNeXtForDigit
...
cardinality=1
bottleneck_type="GroupConv"  #GroupConv,MultiBranch

#在cardinality=32,bottleneck_type=MultiBranch时,精度一般(97.8),速度极慢(12.8s/f)
...
def train():
    ...
    classModel=ResNeXtForDigit.ResNeXtForDigit(is_training=is_training_placeholder , num_classes=len(label_dict),
                               cardinality=cardinality,bottleneck_type = bottleneck_type)
