...
from nets import ShuffleNetV1ForDigit
...
def train():
    ...
    classModel=ShuffleNetV1ForDigit.ShuffleNetV1ForDigit(is_training=is_training_placeholder ,
    ...
    learning_rate = tf.train.exponential_decay(0.0005, global_step, 150, 0.9)
