...
def train():
    ...
    classModel=ResNetV2.ResNetV2(is_training=is_training_placeholder , num_classes=len(label_dict),resNet_type=resNet_type)
    ...
    learning_rate = tf.train.exponential_decay(0.005, global_step, 500, 0.9)
