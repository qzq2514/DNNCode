...
cardinality=2      #ResNeXt as baseline
reduction_ratio=16 #for SE Moudle
...
def train():
    ...
    classModel=SENet_Digit.SENet_Digit(is_training=is_training_placeholder , num_classes=len(label_dict),
