...
#using dropout
class EfficientNet_Digit(object):
    def __init__(self, is_training, num_classes,keep_prob):
    ...
    def inference(self, inputs):
        with slim.arg_scope(self.EfficientNet_arg_scope(is_training=self._is_training)):
            ...
            net_dropout = slim.dropout(net_global_pool,keep_prob=self.keep_prob)
            net = slim.convolution2d(net_dropout, num_outputs=self.num_classes,
