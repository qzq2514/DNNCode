...
class MobileNetV3_Digit(object):
    ...
    def MobileNetV3_digit_config(self):
        config=[
            ...
            MobileNetV3_block("block7", 5,  120,  48, 2, True, True),
    ...
    def MobileNetV3_arg_scope(self,is_training,weight_decay=0.0001,batch_norm_decay=0.95,
