...
model_name="MobileNetForDigit3C_placeholder0604"
...
def train():
    ...
    #is_training=True使用默认placeholder方便转openvino
    is_training_placeholder=tf.placeholder_with_default(False,shape=(),name="is_training")

    classModel=MobileNetForDigit.MobileNetForDigit(is_training=is_training_placeholder,num_classes=len(label_dict))
    ...
    with tf.Session() as sess:
        ...
        for epoch_num in range(total_epoch_num):
            ...
            for iters_num in range(cur_epoch_iters_num):
                ...
                one_moving_meaning=sess.graph.get_tensor_by_name('MobileNetV1/conv_1/batch_norm/moving_mean:0')
                ...
                print("one_moving_meaning:",np.mean(one_moving_meaning.eval()))
