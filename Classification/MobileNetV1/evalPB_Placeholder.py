...
# 在使用默认is_training_placeholder=False进行测试的情况下,和ckpt一样，
# 可以不用重新加载模型进行测试,直接在run的时候将dict中的
# is_training_placeholder置为False,甚至不用加也行,因为默认是False
model_path = 'models/pb/MobileNetForDigit3C_placeholder0604-500.pb'
