...
from nets import ShuffleNetV2ForDigit
...
def train():
    ...
    classModel=ShuffleNetV2ForDigit.ShuffleNetV2ForDigit(is_training=is_training_placeholder ,
    ...
    learning_rate = tf.train.exponential_decay(0.003, global_step, 500, 0.9)
