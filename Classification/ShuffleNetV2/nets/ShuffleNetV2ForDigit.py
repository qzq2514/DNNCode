...
class ShuffleNetV2ForDigit(object):
    ...
    def select_model_scalse(self,model_size):
        ...
        if model_size==0.5:
            return [(48, 4), (96, 8),  (1024, 1)]
        elif model_size == 1.0:
            return [(116, 4), (232, 8), (1024, 1)]
        elif model_size == 1.5:
            return [(176, 4), (352, 8),  (1024, 1)]
        elif model_size == 2.0:
            return [(244, 4), (488, 8),  (2048, 1)]
        else:
        ...
        with slim.arg_scope([slim.convolution2d,slim.separable_convolution2d],
            ...
            with slim.arg_scope([slim.batch_norm],is_training=self.is_training,
                ...
                with tf.variable_scope("init_input"):
                    ...
                    net = slim.max_pool2d(preprocessed_inputs,kernel_size=3,stride=2)
