...
def train():
    ...
    classModel=WideResNet.WideResNet(is_training=is_training_placeholder , num_classes=len(label_dict),
                                     keep_prob=keep_prob_placeholder,
                                     unit_num_in_block=unit_num_in_block,width_k = width_k)
