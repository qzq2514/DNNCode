...
import os
import cv2
from net import CTCRecognizer_CTC_CA_NoRNN_BN_dropout
...
test_dir = "D:/forCaffe/textAreaDet/test_rename"

# models_name="CTC_CA_simpleCNN_l2_argument_"  #没有l2
models_name="CTC_CA_NoRNN_BN_dropout"
...
def train():
    ...
    ctcRecognizer = CTCRecognizer_CTC_CA_NoRNN_BN_dropout.CTCRecognizer(is_training_placeholder,
                                                       dropout_placeholder,
                                                       num_classes, num_hidden=num_hidden)
    ...
    dense_predictions = tf.sparse_to_dense(decode_logits[0].indices,[tf.shape(inputs,out_type=tf.int32)[0],
                                                                     tf.shape(inputs, out_type=tf.int32)[2]/max_step_downsampling_num],
    ...
    learning_rate = tf.train.exponential_decay(0.001, global_step, 3000, 0.9, staircase=True)
    ...
    with tf.Session() as sess:
        ...
        while True:
            ...
            # print(train_targets,no_parse_labels,train_seq_len)
            train_feed = {inputs: train_inputs, sparse_groundtrouth: train_targets,
                          seq_len_placeholder: train_seq_len,is_training_placeholder:True,
            ...
            if global_step_ % snopshot == 0:
                ...
                test_feed = {inputs: test_inputs,seq_len_placeholder: test_seq_len,
                             is_training_placeholder:True,dropout_placeholder:0.5}
