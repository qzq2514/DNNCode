...
model_path = 'models/pb/siamese_triplet_28out_allloss_bn-2400.pb'
...
def eval(test_dataset):
    ...
    #get_base_feature,get_random_base_feature
    base_features = get_base_feature(test_dataset)
